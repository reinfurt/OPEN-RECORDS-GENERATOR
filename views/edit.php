		...
		> -->
			<div class="form">
				...
				function addListeners(name) {
					...
					document.getElementById(name + '-red').addEventListener('click', function(e) {resignImageContainer(name);}, false);
				...
				function showrich(name) {
					...
					var red = document.getElementById(name + '-red');
				...
				function small(name){
                    ...
                    // declare css style for <aside> block element in main.css
